...
s.t. startingMidfieldersLo: sum{k in name_M} s_M[k] >= 4;

# number of strikers in starting squad
s.t. startingStrikersUp: sum{k in name_S} s_S[k] <= 3;
s.t. startingStrikersLo: sum{k in name_S} s_S[k] >= 2;

# 12 Freunde muesst ihr sein!
s.t. elfFreunde: sum{k in name_G} s_G[k] 
                + sum{k in name_D} s_D[k] 
                + sum{k in name_M} s_M[k] 
                + sum{k in name_S} s_S[k] = 12;

solve;

printf "==========================================================\n";
printf "|                                                        |\n";
printf "|  Ergebnis der Optimierung fuer die 12 besten Spieler:  |\n";
printf "|                                                        |\n";
printf "==========================================================\n";
