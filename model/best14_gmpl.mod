...
s.t. startingGoaliesUp: sum{k in name_G} s_G[k] <= 2;
...
# 14 Freunde muesst ihr sein!
s.t. elfFreunde: sum{k in name_G} s_G[k] 
                + sum{k in name_D} s_D[k] 
                + sum{k in name_M} s_M[k] 
                + sum{k in name_S} s_S[k] = 14;

solve;

printf "==========================================================\n";
printf "|                                                        |\n";
printf "|  Ergebnis der Optimierung fuer die 14 besten Spieler:  |\n";
printf "|                                                        |\n";
printf "==========================================================\n";
